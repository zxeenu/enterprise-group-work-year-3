...
//    3. Customer
    ...
    public String AssignTOTPSecret() {
        this.TOTPSecret = main.Common.Security.GenerateTOTPSecret();
        return TOTPSecret;
    }
    ...
    public boolean ConfirmTOTP(String code) {
        ...
        return main.Common.Security.VerifyTOTPCode(this.TOTPSecret, code);
    }
    ...
    public main.Database.Entities.Role getRole() {
        return Role;
    }
}
