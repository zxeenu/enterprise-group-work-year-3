...
import main.Database.Entities.Role;
...
public class UserModule {
    ...
    public User GetByUsername(String u) {
        var useriterator = main.Common.Shared.DbContext.Users.iterator();
    ...
    public User RegisterNewUser(String firstname, String lastname, String username, String password, User.UserType uc) throws SQLException {
        ...
        main.Common.Shared.DbContext.Users.create(newuser);
        return newuser;
    }
    ...
    public ArrayList<User> GetAllUsers() {
        ...
        var iterator = main.Common.Shared.DbContext.Users.iterator();
        while (iterator.hasNext()) {
    ...
    public void UpdateUser(User u) throws SQLException {
        main.Common.Shared.DbContext.Users.update(u);
    }
    ...
    public void DeleteUser(User u) throws SQLException {
        main.Common.Shared.DbContext.Users.delete(u);
    }
}
